...
H~0~: **[pH does not predict growth in shell surface area per day]**  

H~A~: **[pH does predict growth in shell surface area per day]**
...
```
**Residuals seem Homoscedastic based on residuals vs fitted and scale location plot. Residuals seem normally distributed based on the QQ Plot. There were also no outliers based on Residuals vs leverage.
...
**when pH = 0, abalone change in shell surface area per day is -18.5**
...
At pH = 8, the model predicts that abalone change in shell surface area per day should be 5.36 mm^2^ day^-1$
